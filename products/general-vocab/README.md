...
- 詞彙資料：[`cards_data.json`](cards_data.json)（100 字，僅供參考／備份，實際資料內嵌在 html 裡）

## 資料怎麼來的

1. 抓取 13 場公開逐字稿全文（rev.com、singjupost.com、stratechery.com、blog.google 等，CNBC/Bloomberg/Axios 等站點會擋爬蟲，暫時抓不到）
